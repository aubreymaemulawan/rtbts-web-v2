            ...
            <div class="card-body pad">
                <div class="tbl table-responsive text-nowrap">
                    <table id=dataTable class="table table-hover">
                        ...
                        <tbody id="realtime_table_operator_trip" class="table-border-bottom-0">
...
@section('scripts')
    <script>
        ...
        $('#main-operator-trip').addClass('active open')
        ...
        function loadXMLDoc() {
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    document.getElementById("realtime_table_operator_trip").innerHTML =
                    this.responseText;
                }
            };
            xhttp.open("GET", "./tbl-operator-trip", true);
            xhttp.send();
        }
