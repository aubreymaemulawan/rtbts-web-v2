                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <a href="./dispatcher-trip" class="btn btn-sm btn-outline-primary">View Trips</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @foreach($trips as $tr)
                                    @if($tr->personnel_schedule->dispatcher_id == Auth::user()->personnel_id)
                                    <?php $cnt++;?>
                                    @endif
                                @endforeach
                                @foreach($trip_today as $trt)
                                    @if($trt->personnel_schedule->dispatcher_id == Auth::user()->personnel_id)
                                    <?php $cnt1++;?>
                                    @endif
                                @endforeach
                                @foreach($trip_month as $trm)
                                    @if($trm->personnel_schedule->dispatcher_id == Auth::user()->personnel_id)
                                    <?php $cnt2++;?>
                                    @endif
                                @endforeach
                                @foreach($trip_year as $try)
                                    @if($try->personnel_schedule->dispatcher_id == Auth::user()->personnel_id)
                                    <?php $cnt3++;?>
                                    @endif
                                @endforeach
                                <?php 
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @foreach($perscheds as $ps)
                                    @if($ps->dispatcher_id == Auth::user()->personnel_id)
                                    <?php $cns++;?>
                                    @endif
                                @endforeach
                                @foreach($persched_today as $pst)
                                    @if($pst->dispatcher_id == Auth::user()->personnel_id)
                                    <?php $cns1++;?>
                                    @endif
                                @endforeach
                                @foreach($persched_month as $psm)
                                    @if($psm->dispatcher_id == Auth::user()->personnel_id)
                                    <?php $cns2++;?>
                                    @endif
                                @endforeach
                                @foreach($persched_year as $psy)
                                    @if($psy->dispatcher_id == Auth::user()->personnel_id)
                                    <?php $cns3++;?>
                                    @endif
                                @endforeach
                                <?php 
...
@section('scripts')
    <script>
        ...
        $('#main-dispatcher-dashboard').addClass('active open')
