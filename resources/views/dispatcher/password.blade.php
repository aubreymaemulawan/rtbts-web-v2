        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                        <a class="nav-link" href="./dispatcher-profile">
                ...
                <div id="main" class="card mb-4">
                    ...
                    @csrf
                        <h5 class="card-header">Change Personnel Password</h5>
                        <hr class="my-0"/>
                        <br>
                        <div class="card-body">
...
@section('scripts')
    <script>
        ...
        $('#menu-dispatcher-profile').addClass('active')
        ...
        $(document).ready(function (e) {
            ...
            $(document).on('submit','#updating', function(e) {
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ url('/api/personnel/update_password') }}",
                    data: editformData,
                    cache: false,
                    dataType: 'json',
                    contentType: false,
