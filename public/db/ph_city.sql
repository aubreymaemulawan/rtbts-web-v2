...
--
-- Table structure for table `ph_city`
--

CREATE TABLE `ph_city` (
...
--
-- Dumping data for table `ph_city`
--

INSERT INTO `ph_city` (`id`, `city_name`, `province_id`) VALUES
(1, 'Bangued', 1),
(2, 'Boliney', 1),
(3, 'Bucay', 1),
(4, 'Bucloc', 1),
...
--
-- AUTO_INCREMENT for table `ph_city`
--
ALTER TABLE `ph_city`
...
--
-- Constraints for table `ph_city`
--
ALTER TABLE `ph_city`
  ADD CONSTRAINT `ph_city_ibfk_1` FOREIGN KEY (`province_id`) REFERENCES `ph_province` (`id`) ON UPDATE CASCADE;
COMMIT;
